...
namespace DoAnHMS.Controllers
{
    ...
    {
        private readonly doanKSEntities db = new doanKSEntities();
        ...
        [HasCredential(IDQuyen = "QUANLYPHANHOI")]
        public ActionResult Edit(int id, bool tinhTrang)
        {
            var phanHoiUpdate = db.PhanHois.Find(id);
            if (phanHoiUpdate != null)
            {
                phanHoiUpdate.tinhTrang = tinhTrang;
                db.SaveChanges();
                return RedirectToAction("Index");
            }
            return View(phanHoiUpdate);
        }
